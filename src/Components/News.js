                ...
                <center>
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <NewsItem title="mytitle" description="mydescription" imageUrl="https://talksport.com/wp-content/uploads/sites/5/2022/01/TALKSPORT-MORGAN.jpg?strip=all&quality=100&w=1200&h=800&crop=1"/>
                        </div>
                        <div className="col-md-4">
